...
public class BaseMusicPlayerActivity extends BaseTitleActivity implements View.OnClickListener, OnMusicPlayerListener, PlayListListener {
  ...
  private void showPlayListDialog(){
   ...
   //musicPlayer.addOnMusicPlayerListener
    @Override
    public void onProgress(long progress, long total) {
        //在这里设置progressBar设置进度，以及当前的播放进度反馈到当前的单行view
    ...
    public void onPaused(Song data) {
        //iv_play_small_controller.setImageResource(R.drawable.selector_music_play)
