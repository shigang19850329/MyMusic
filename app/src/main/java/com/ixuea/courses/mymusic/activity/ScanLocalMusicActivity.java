...
import static com.ixuea.courses.mymusic.R.drawable;
import static com.ixuea.courses.mymusic.R.id;
import static com.ixuea.courses.mymusic.R.layout;
import static com.ixuea.courses.mymusic.R.string;
...
public class ScanLocalMusicActivity extends BaseTitleActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.activity_scan_local_music);
    }
    ...
    protected void initViews() {
        ...
        iv_scan_music_zoom = findViewById(id.iv_scan_music_zoom);
        iv_scan_music_line = findViewById(id.iv_scan_music_line);
        tv_progress = findViewById(id.tv_progress);
        bt_scan_music = findViewById(id.bt_scan_music);
    }
    ...
    public void onClick(View v) {
        ...
        if (isScanning){
            isScanning = false;
            bt_scan_music.setText(string.start_scan);
            bt_scan_music.setBackgroundResource(drawable.selector_button_reverse);
            bt_scan_music.setTextColor(getResources().getColorStateList(R.drawable.selector_text_reverse));
            //bt_scan_music.setTextColor(getResources().getColorStateList(R.color.white));
            stopScan();
        }else{
            isScanning = true;
            bt_scan_music.setText(string.stop_scan);
            bt_scan_music.setBackgroundResource(drawable.selector_button);
            bt_scan_music.setTextColor(getResources().getColorStateList(R.drawable.selector_text));
            //bt_scan_music.setTextColor(getResources().getColorStateList(R.color.main_color));
            startScan();
        }
    }
    ...
    private void startScanMusic() {
        ...
        new AsyncTask<Void,String,List<Song>>(){
            ...
            protected void onPostExecute(List<Song> songs) {
                ...
                isScanComplete = true;
                stopScan();
                tv_progress.setText(getResources().getString(string.find_music_count,songs.size()));
                bt_scan_music.setBackgroundResource(drawable.selector_button_reverse);
                bt_scan_music.setTextColor(getResources().getColorStateList(R.drawable.selector_text_reverse));
                bt_scan_music.setText(string.go_my_music);
            }
        }.execute();
    }
