 ...
 */
public class
ConversationDetailAdapter extends BaseRecyclerViewAdapter<Message, ConversationDetailAdapter.BaseViewHolder> {
    ...
    @NonNull
    @Override
    public ConversationDetailAdapter.BaseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        /**
         * 这里要区分是我发送的，还是其他人发送到
