    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isAccurate){
            ...
            LogUtil.d("LyricLineView onDraw lineLyricPlayedWidth:"+lineLyricPlayedWidth);
             //裁剪一个矩形用来绘制已经唱的歌词。
            //canvas.clipRect(centerX,centerY-textHeight,centerX+lineLyricPlayedWidth,centerY+textHeight);
            canvas.clipRect(centerX,0,centerX+lineLyricPlayedWidth,getMeasuredHeight());
//            //这个矩形包是文字的高度+行高,画一个矩形的框，方便理解宽高的概念。
//            canvas.drawRect(centerX,centerY-textHeight,centerX+lineLyricPlayedWidth,
//                    centerY+textHeight,testPaint);
